...
namespace CityInfo.API.Controllers
{
    ...
    public class CitiesController : ControllerBase //not controller because controller has helper functions that help return views but controller base is smaller and fits apis more
    {
        ...
        )
        {
            ...
            var (citiesEntities, pagintationMetaData) = await _cityInfoRepository.GetCitiesAsync(
                name,
                searchQuery,
                pageNumber,
                pageSize
            ...
            Response.Headers.Add("X-Pagination", JsonSerializer.Serialize(pagintationMetaData));
